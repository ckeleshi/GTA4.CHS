...
public:
    ...
    const GTAChar* Font_ProcessToken(const GTAChar* text, uint* color, bool get_color, uchar* color_code, int* key_number, bool* is_new_line_token, GTAChar* text_to_show, TokenStruct* token_data);
