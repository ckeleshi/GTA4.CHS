...
void CGame::Font_ProcessString(float posx, float posy, const GTAChar* str, void* a4)
{
    injector::cstd<void(float, float, const GTAChar*, void*)>::call(game_addr.fnFont_ProcessString, posx, posy, str, a4);
}
